...
// On boarding page fonts
  ...
  String babyNameSuggestion = "Baby name suggestion";
  String cvMaker = "CV maker";
  String giftSuggestion = "Gifts suggestion";
  String birthdayMessage = "Birthday message";
  String anniversaryMessage = "Anniversary message";
  String weddingWishes = "Wedding wishes";
  String newBabyWishes = "New baby wishes";
  String getWellMessage = "Get well message";
  String newYearWishes = "New year wishes";
  String valentineDay = "Valentine day";
  String mothersDayWishes = "Mother’s day wishes";
  String fathersDayWishes = "Father’s day wishes";
  String promotionWishes = "Promotion wishes";
  String babyShowerMessage = "Baby shower message";
  String farewellMessage = "Farewell message";
  String getLatestNames = "Get latest names for my baby :";
  String selectGender = "Select gender";
  String boy = "Boy";
  String girl = "Girl";
  String nameSuggestion = "Name suggestion as per";
  String zodiac = "Zodiac";
  String letter = "Letter";
  String selectZodiac = "Select Zodiac";
  String suggestMeTheLovelyName = "Suggest me the lovely name";
  String someCuteNames = "Some cute names for lovely baby :";
  ...
  String writeFullName = "Write full name";
  String writeNumber = "Write number";
  String writeMail = "Write mail";
  String positionLooking = "Position looking for";
  String experience = "Experience";
  String whyYouWantThisJob = "Why you want this job";
  String customMessage = "Custom message";
  String writeOtherThings = "Write other things you want to add";
  String createProfessionalCv = "Create professional CV";

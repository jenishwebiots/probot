...
// On boarding page fonts
  ...
  String openAiChatGpt = "OpenAI Chat GPT is a powerful artificial intelligence platform that uses state-of-the-art AI.";
  String easilyGenerateImage = "Easily generate Image";
  String toReceiveTheFinest = "To receive the finest results and a time-saving tool, simply input the image you desire and its size.";
  String quickCreation = "Quick creation of content";
  String enterTheTitle = "Enter the title you desire material for to obtain the best outcome without copies, and you may adjust it.";

  String quickAnswerFor = "Quick Answer for anything you want";
  String aBuddyWhoAvailable = "A buddy who is available to you at all times for conversation or utilization as a p.a.";

...
class QuickAdvisorLayout extends StatelessWidget {
 ...
 final bool isFavorite;
  ...
  const QuickAdvisorLayout(
      {Key? key, this.data, this.selectIndex , this.onTap, this.index,this.isFavorite = false})
      : super(key: key);
    ...
    return Stack(
      ...
      children: [
        Stack(alignment: Alignment.bottomCenter, children: [
          Stack(alignment: Alignment.topLeft, children: [
            Container(
                ...
                height: Sizes.s102,
                width: Sizes.s100,
                child: Image.asset(eImageAssets.quickAdvisorContainer,color: appCtrl.appTheme.boxBg,
                    alignment: Alignment.bottomCenter)),
            SizedBox(
                    height: Sizes.s45,
                    width: Sizes.s45,
        ...
        SvgPicture.asset(isFavorite ? eSvgAssets.fillStar : selectIndex != null ? selectIndex == index
                ? eSvgAssets.fillStar
                : eSvgAssets.unFillStar: eSvgAssets.unFillStar)
            .inkWell(onTap: onTap)

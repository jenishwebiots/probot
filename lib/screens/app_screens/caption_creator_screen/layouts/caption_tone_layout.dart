...
class CaptionToneLayout extends StatelessWidget {
  ...
  const CaptionToneLayout({Key? key,this.data,this.onTap,this.index,this.selectedIndex}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Text(data["title"].toString().tr,
          style: AppCss.outfitSemiBold14.textColor(index == selectedIndex ? appCtrl.appTheme.primary : appCtrl.appTheme.txt))
    ]).inkWell(onTap: onTap);
  }
}

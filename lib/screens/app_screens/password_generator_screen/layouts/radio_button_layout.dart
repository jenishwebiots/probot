...
class PasswordRadioButtonLayout extends StatelessWidget {
  ...
  const PasswordRadioButtonLayout({Key? key,this.index,this.selectIndex,this.data,this.onTap}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(data.toString().tr,style: AppCss.outfitMedium14.textColor(appCtrl.appTheme.txt))
      ],

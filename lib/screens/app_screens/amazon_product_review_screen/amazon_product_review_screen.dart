        ...
        return Scaffold(
          ...
          body: Column(
            children: [
             ...
             amazonProRevCtrl.isProductGenerated == true ? Column(
               ...
               Column(
                 ...
                 children: [
                   ...
                   Column(
                     crossAxisAlignment: CrossAxisAlignment.start,
                     children: [
                       textCommon.outfitSemiBoldTxt14(text: appFonts.productDetail),
                       const VSpace(Sizes.s10),
                       TextFieldCommon(
                   ...
                   const VSpace(Sizes.s30),
                   ButtonCommon(title: appFonts.bringMeTheBestDetail,onTap: ()=> amazonProRevCtrl.onProductGenerated()),
                 ]
               )
            ]

...
class SocialMediaListLayout extends StatelessWidget {
  ...
  const SocialMediaListLayout({Key? key,this.data,this.onTap,this.index}) : super(key: key);
    ...
    return Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        SvgPicture.asset(
            ...
            height: 15,
            colorFilter:
                ColorFilter.mode(appCtrl.appTheme.txt, BlendMode.srcIn)).paddingSymmetric(horizontal: Insets.i10)
